...
main = do
    ...
    check "test3-3-1" (code2str (_getCode code3)) "declare double @0() {\nentry:\n\t%addtmp0 = fadd double 4.0, 5.0\n\tret double %addtmp0\n}\n"
